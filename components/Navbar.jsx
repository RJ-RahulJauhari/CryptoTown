      ...
      <div className="max-w-screen-xl mx-auto p-4">
        ...
        <div className="hidden md:flex md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/explore">
              <button className={`border ${theme === 'dark' ? 'border-blue-500 text-white' : 'border-blue-600 text-gray-900'} hover:bg-${theme === 'dark' ? 'blue-400' : 'blue-700'} text-sm px-4 py-2 rounded-lg bg-transparent`}>
                Explore
              </button>
            </Link>
            <button
        ...
        <div className="flex md:hidden flex-col">
          ...
          <div className='flex flex-row justify-end item'>
          <button
            type="button"
            onClick={toggleSidebar}
            className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg mt-4 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            aria-controls="mobile-menu-2"
            aria-expanded="false"
          >
            <span className="sr-only">Open main menu</span>
          ...
          <button
            type="button"
            onClick={toggleTheme}
            className={`inline-flex items-center p-2 text-sm text-gray-500 rounded-lg mt-4 ${theme === 'dark' ? 'dark:text-gray-400' : 'text-gray-500'} hover:bg-gray-100 dark:hover:bg-gray-700 dark:focus:ring-gray-600`}
          >
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          <Link href="/explore" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg mt-4 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            <svg
              ...
              aria-hidden="true"
            >
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2 2l5-5l4 4l7-7" />
            </svg>
          </Link>
          </div>
          </div>
