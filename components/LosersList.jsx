...
const LosersList = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Filter losers (negative change in the last 24 hours)
        const losers = allMarketData.filter(crypto => crypto.price_change_percentage_24h < 0);
        setData(losers);
      } catch (error) {
  ...
  return (
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
      {/* <h1 className="text-3xl font-bold mt-8 mb-8">Top Losers</h1> */}
